...
export default function MintingApp() {
  ...
  const loadContractData = async (userAccount: string) => {
    try {
      ...
      setError('Failed to load contract data. Make sure contract address is correct.');
    }
  };
          ...
          <>
            <div className="mb-6 space-y-3">
              ...
              <div className="bg-gray-100 p-4 rounded-lg">
                ...
                <p className="text-2xl font-bold text-blue-600">{balance} SMT</p>
              </div>

              {isOwner && (
                <div className="bg-green-100 border border-green-400 p-4 rounded-lg">
                  <p className="text-sm font-semibold text-green-800">You are the owner</p>
                </div>
              )}
            </div>
            ...
            {isOwner ? (
              ...
              <div className="bg-yellow-100 border border-yellow-400 p-4 rounded-lg text-center">
                <p className="text-sm text-yellow-800">Only the contract owner can mint tokens</p>
              </div>
            )}
